...
* <a href="#a" target="_self">排查思路及方法</a>
    ...
    * <a href="#a2" target="_self">进程排查命令</a>
    	* <a href="#a3" target="_self">查看当前系统状态</a>
    	* <a href="#a4" target="_self">查看当前系统进程信息</a>
    	* <a href="#a5" target="_self">查看非root运行的进程</a>
    	* <a href="#a6" target="_self">查看用户root运行的进程</a>
    	* <a href="#a7" target="_self">查看有没有奇怪进程</a>
    	* <a href="#a8" target="_self">检测隐藏进程</a>
    	* <a href="#a9" target="_self">检测系统守护进程</a>
    * <a href="#b" target="_self">任务及用户活动排查命令</a>
    	* <a href="#b1" target="_self">查看当前有谁登陆在服务器上</a>
    	* <a href="#b2" target="_self">查看当前登陆用户的IP信息</a>
    	* <a href="#b3" target="_self">查看近期用户登陆情况</a>
    	* <a href="#b4" target="_self">查看历史命令</a>
    	* <a href="#b5" target="_self">查看空口令账号</a>
    	* <a href="#b6" target="_self">查看uid为0的账号</a>
    	* <a href="#b7" target="_self">查看进程树是否所有异常</a>
    * <a href="#c" target="_self">网络排查命令</a>
    	* <a href="#c1" target="_self">列出本机所有的连接和监听的端口，查看有没有非法连接</a>
    	* <a href="#c2" target="_self">查看谁在使用某个端口</a>
    	* <a href="#c3" target="_self">查看多个进程号对应的文件信息</a>
    	* <a href="#c4" target="_self">查看所有tcp网络连接信息</a>
    	* <a href="#c5" target="_self">查看所有udp网络连接信息</a>
    * <a href="#d" target="_self">文件排查命令</a>
    	* <a href="#d1" target="_self">查看所有文件，包括隐藏的文件</a>
    	* <a href="#d2" target="_self">查看文件路径</a>
    	* <a href="#d3" target="_self">查看文件创建时间</a>
    	* <a href="#d4" target="_self">查找最近24小时内修改过的文件</a>
    	* <a href="#d5" target="_self">查找以.txt结尾的文件名</a>
    	* <a href="#d6" target="_self">查找不是以.txt结尾的文件</a>
...
### <span id = "a5">查看非root运行的进程(ps)</span>
...
### <span id = "a6">查看用户root运行的进程(ps)</span>
...
### <span id = "b1">查看当前有谁登陆在服务器上(who)</span>
...
### <span id = "b2">查看当前登陆用户的IP信息(who)</span>
...
### <span id = "b3">查看近期用户登陆情况(last)</span>
...
### <span id = "b4">查看历史命令(history)</span>
...
### <span id = "b6">查看uid为0的账号(awk)</span>
...
### <span id = "b7">查看uid为0的账号(grep)</span>
...
### <span id = "b8">查看进程树是否所有异常进程存在一个父进程、判断进程的父子关系(pstree)</span>
...
### <span id = "c1">列出本机所有的连接和监听的端口，查看有没有非法连接(netstat)</span>
...
### <span id = "c2">查看谁在使用某个端口(lsof)</span>
...
### <span id = "c3">查看多个进程号对应的文件信息(lsof)</span>
...
### <span id = "c4">查看所有tcp网络连接信息(lsof)</span>
...
### <span id = "c5">查看所有udp网络连接信息(lsof)</span>
...
### <span id = "d1">查看所有文件，包括隐藏的文件(ls)</span>
...
### <span id = "d2">查看文件路径(whereis)</span>
...
### <span id = "d4">查找最近24小时内修改过的文件(find)</span>
...
### <span id = "d5">查找以.txt结尾的文件名(find)</span>
...
### <span id = "d6">查找不是以.txt结尾的文件(find)</span>
