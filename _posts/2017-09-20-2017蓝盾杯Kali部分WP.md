...
### 题目
![imgaes](/images/2017-09-20/ld1.png)
...
![imgaes](/images/2017-09-20/ld2.png)

nmap -sV -PN 192.168.30.20
![imgaes](/images/2017-09-20/ld3.png)

第一题的题目提示是ftp，那么使用msf尝试若口令破解<br/>
user.txt

![imgaes](/images/2017-09-20/ld4.png)

pass.txt

![imgaes](/images/2017-09-20/ld5.png)

```
msf auxiliary/scanner/ftp/ftp_login模块破解
```
![imgaes](/images/2017-09-20/ld6.png)

得到2个账户，经测试得匿名帐号不能上传，test帐号可以

![imgaes](/images/2017-09-20/ld7.png)

连接ftp找到flag1

![imgaes](/images/2017-09-20/ld8.png)

上传asp大马，发现都不能解析执行。

![imgaes](/images/2017-09-20/ld9.png)

![imgaes](/images/2017-09-20/ld10.png)

cer证书格式也可以被iis解析，修改后缀，上传执行成功

![imgaes](/images/2017-09-20/ld11.png)

![imgaes](/images/2017-09-20/ld12.png)

cms目录是ftp目录，先看看上一级目录，<br/>
发现网站目录D:/wwwroot/web1/wwwroot<br/>
wordpress存放数据库密码的文件是：wp-config.php

![imgaes](/images/2017-09-20/ld13.png)

下载打开发现flag2

![imgaes](/images/2017-09-20/ld14.png)

登录mysql，查询该用户是普通用户

![imgaes](/images/2017-09-20/ld15.png)
...
![imgaes](/images/2017-09-20/ld17.png)
![imgaes](/images/2017-09-20/ld18.png)
...
### 第一题：三个flag之FTP中的秘密
![imgaes](/images/2017-09-20/ld19.png)

### 第二题：三个flag之连接数据库的钥匙
![imgaes](/images/2017-09-20/ld20.png)
...
### 第四提：签到
打开第四题题目->搜索flag即可
![imgaes](/images/2017-09-20/ld21.png)

### 第五题：蓝盾安全，与你同行
获取信息，根据User-Agent来判断浏览器
![imgaes](/images/2017-09-20/ld22.png)

使用burpsuite拦截，然后把User-Agent的值改成bluedon即可得到flag

![imgaes](/images/2017-09-20/ld23.png)

### 第六题：慢点，慢点，再慢点

提示说为空，并不是说没密码，尝试'' ，“”，”null”，null，最后null成功

![imgaes](/images/2017-09-20/ld24.png)

需要burpsuite拦截，不然会跳转到另外一个页面
![imgaes](/images/2017-09-20/ld25.png)

再用burpsuite访问lll.html得到flag

![imgaes](/images/2017-09-20/ld26.png)

### 第七题：听说静静的密码丢了

![imgaes](/images/2017-09-20/ld27.png)

尝试不填密码登录，得到提示：4位数字的密码<br/>
使用burpsuite暴力破解即可

![imgaes](/images/2017-09-20/ld28.png)

![imgaes](/images/2017-09-20/ld29.png)

### 第八题：会中文不是万能的
访问得到信息，应该是根据语言来判断国家的 (http头：Accept-Language)
![imgaes](/images/2017-09-20/ld30.png)

使用burpsuite拦截，然后把Accept-Language 的值改成en-US即可得到flag
![imgaes](/images/2017-09-20/ld31.png)

### 第九题：猪圈陷阱
打开题目文件，是一串url编码
![imgaes](/images/2017-09-20/ld32.png)
...
![imgaes](/images/2017-09-20/ld37.png)

扫到个login.php，登录一看，是帐号密码

![imgaes](/images/2017-09-20/ld38.png)

修改密码后提交，得到新页面（其实只要修改cookie中的password就可以了）

![imgaes](/images/2017-09-20/ld39.png)

打开新页面-->查看源码-->最下端

![imgaes](/images/2017-09-20/ld40.png)

这说明点击后会跳转到一个新页面,在看上面2个数
第一个像md5
第二个先来base64看看

![imgaes](/images/2017-09-20/ld41.png)

6位数字，好办。<br/>
第一个是md5,可使用工具进行暴力破解对比<br/>
如果没有好的工具，那就不管第一个了，直接使用burpsuite暴力破解即可

![imgaes](/images/2017-09-20/ld42.png)

![imgaes](/images/2017-09-20/ld43.png)

### 第十一题：奇奇怪怪的路径？
访问：www.bdctf9.com/robots.txt

![imgaes](/images/2017-09-20/ld44.png)

访问：www.bdctf9.com/admin+login/bluedon.asp

![imgaes](/images/2017-09-20/ld45.png)

### 第十二题：探险
www.bdctf0.com
查看源码发现信息

![imgaes](/images/2017-09-20/ld46.png)

在控制台执行脚本后得到明文

![imgaes](/images/2017-09-20/ld47.png)

在将window.location.href的值进行base64解码得到flag

![imgaes](/images/2017-09-20/ld48.png)

### 第十三题：这是小静的自拍照，你能找到亮点吗？
一看见图片，先丢进winhex里在说，在结尾处发现是PK，说明是一个zip文件

![imgaes](/images/2017-09-20/ld49.png)

把zip提取出来:编辑-->定义选块
我这里偏移是84F1-87FF（从开头搜索到的地一个PK，就是rar文件的开头）

![imgaes](/images/2017-09-20/ld50.png)

选中后再点击编辑-->复制选块-->至新文件-->存为1.zip

![imgaes](/images/2017-09-20/ld51.png)

解压1.zip得到pcapng数据包，用wireshark打开，结果为一次ping请求

![imgaes](/images/2017-09-20/ld52.png)

看了一轮，发现每一个ICMP包都带有一个字符

![imgaes](/images/2017-09-20/ld53.png)

最后结果得到：flag{5efv38f2}

### 第十四题：真真假假
![imgaes](/images/2017-09-20/ld54.png)

使用wireshark打开hack.pcapng包，发现有rar上传

![imgaes](/images/2017-09-20/ld55.png)

导出该包另存为rar

![imgaes](/images/2017-09-20/ld56.png)

打开发现是损坏的

![imgaes](/images/2017-09-20/ld57.png)

修复一下即可得到flag：repair 导出的压缩包

![imgaes](/images/2017-09-20/ld58.png)

修复之后的新压缩包不用密码就可直接获取该flag图片

![imgaes](/images/2017-09-20/ld59.png)

### 第十五题：莫名的用户
![imgaes](/images/2017-09-20/ld60.png)

开启自动添加用户，说明在启动时执行了脚本添加用户，linux的启动脚本是在/etc/rc.local

![imgaes](/images/2017-09-20/ld61.png)

进入脚本所在位置查看里面内容

![imgaes](/images/2017-09-20/ld62.png)

此脚本内容为开机启动检查是否有bluedon用户，没有则自动创建。flag在脚本标注里

![imgaes](/images/2017-09-20/ld63.png)

### 第十六题：混合编码
题目结合文件名应该是base64和base32替换编码

![imgaes](/images/2017-09-20/ld64.png)
...
![imgaes](/images/2017-09-20/ld65.png)

### 第十八题：面无表情的凤姐
把凤姐.jpg拖进winhex里，搜索flag{

![imgaes](/images/2017-09-20/ld66.png)

### 第十九题：小静想蹭楼下那个同样刚毕业两年的女生家的WiFi，实现他的梦想吧。
毕业两年？试试生日。使用python生成一个自定义格式的字典

![imgaes](/images/2017-09-20/ld67.png)

wifi破解：aircrack-ng -w pass.txt xx.cap 得到哦密码19990908

![imgaes](/images/2017-09-20/ld68.png)

### 第二十题：什么鬼密码
![imgaes](/images/2017-09-20/ld69.png)

![imgaes](/images/2017-09-20/ld70.png)
...
![imgaes](/images/2017-09-20/ld78.png)

第一个rar名字和题目猜测密码是 王尼玛 wangnima（正确） 尼玛之类的<br/>
打开文件一看是王尼玛的个人信息，根据信息生成密码字典

![imgaes](/images/2017-09-20/ld79.png)

使用密码字典破解第二个rar

![imgaes](/images/2017-09-20/ld80.png)

![imgaes](/images/2017-09-20/ld81.png)

### 第二十六题：
打开文本，是一个jsfuck编码，丢到控制台打印一下得到base64

![imgaes](/images/2017-09-20/ld82.png)

然后解码得到flag

![imgaes](/images/2017-09-20/ld83.png)

### 第二十七题：古老的东西
打开文本一看是一个html编码，解码得到 lag{thlfsuudsleuiqqawnqwgetntcifpuoa}tyd

![imgaes](/images/2017-09-20/ld84.png)
...
![imgaes](/images/2017-09-20/ld85.png)
...
![imgaes](/images/2017-09-20/ld86.png)

### 第三十题：我们有什么不同
打开文件夹有2个txt文件，使用diff命令对比2个文件即可得到flag

![imgaes](/images/2017-09-20/ld87.png)
