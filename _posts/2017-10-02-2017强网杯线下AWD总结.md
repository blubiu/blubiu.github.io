...
* <a href="#f1" target="_self">进攻篇</a>
* <a href="#f2" target="_self">防御篇</a>
    * <a href="#f3" target="_self">1. 修改代码</a>
    * <a href="#f4" target="_self">2. 改admin密码</a>
    * <a href="#f5" target="_self">3. 修改注册代码</a>
    * <a href="#f6" target="_self">4. 挂waf</a>
* <a href="#zj" target="_self">后续</a>
...
这次线下攻防用的是一个**Finecms** ，版本是**5.0.9**的

比赛的时候对这个**cms**并不了解<br/>
...
PS: 因为直接上传的话**phtml**可能不行，他会判断是不是图片.<br/>
...
### <span id = "f3">1. 修改代码</span>

```php
$bad_ext=array('php','php3','php4','php5');
```

可以看到这段代码，没过滤**phtml**，这里可以添加上去，<br/>
...
可以直接**包含在index里面**，注意waf所在目录 <br>

![images](/images/2017-10-02/qwb11.png)

------

你可以添加过滤各种函数，符号，**base64**编码等等<br/>
